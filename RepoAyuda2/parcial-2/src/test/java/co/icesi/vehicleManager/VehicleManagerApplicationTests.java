...
class VehicleManagerApplicationTests {
	...
	void testCreateVehicle() {
		...
		ResponseEntity<Map> response = restTemplate.postForEntity("/vehicle",request, Map.class);
	...
	void testUpdateVehicle() {
		...
		ResponseEntity<Map> createResponse = restTemplate.postForEntity("/vehicle", createRequest, Map.class);
		...
		ResponseEntity<Map> updateResponse = restTemplate.exchange("/vehicle", HttpMethod.PUT, updateRequest,
				Map.class);
	...
	void testDeleteVehicle() {
		...
		ResponseEntity<Map> getResponse = restTemplate.exchange("/vehicle/" + vehicleId, HttpMethod.GET, deleteRequest,
				Map.class);
		assertThat(getResponse.getStatusCode()).isEqualTo(HttpStatus.OK);

		ResponseEntity<Void> deleteResponse = restTemplate.exchange("/vehicle/" + vehicleId, HttpMethod.DELETE,
				deleteRequest, Void.class);

		assertThat(deleteResponse.getStatusCode()).isEqualTo(HttpStatus.OK);

		getResponse = restTemplate.exchange("/vehicle/" + vehicleId, HttpMethod.GET, deleteRequest,
				Map.class);
	...
	void testGetAllVehicles() {
		...
		ResponseEntity<Map[]> response = restTemplate.exchange("/vehicle", HttpMethod.GET, request, Map[].class);
